        ...
        fs.createReadStream(`${filePath}/${req.file.originalname}`)
          ...
          .on("end", async () => {   
            ...
            try {
              ...
              if(record.parent_category_name
                 &&
                 record.parent_category_name != ""){
                  ...
                  parent_category_insertId = result.insertId?result.insertId: result[0].id;
                ...
                if(record.category_name &&
                  ...
                  parent_category_insertId!==""){
                    ...
                    const result = await categories.addCategory(data, res);
                    category_insertId = result.insertId?result.insertId:result[0].id
                  }
                }
              ...
              if(record.color
                ...
                while(s < brand_name_array.length){
                  ...
                  brands_insertIds.push(result.insertId ? result.insertId : result[0].id)
                  s++
                }
